...
namespace xtveyor {
    ...
    inline std::size_t offsetAndStridesFromRoi(const std::vector<size_t> & outStrides,
                                          const std::vector<size_t> & requestShape,
                                          const std::vector<size_t> & offsetInRequest,
                                          std::vector<size_t> & requestStrides) {
    ...
    inline void copyBufferToViewND(const std::vector<T> & buffer,
        ...
        std::vector<size_t> dimPositions(dim);
